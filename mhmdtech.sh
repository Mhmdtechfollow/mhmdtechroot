...
addprofile()
{
	cat > ${PREFIX}/share/mhmdtech/etc/profile <<- EOM
...
addmotd() {
	cat > ${PREFIX}/share/mhmdtech/etc/profile.d/motd.sh  <<- EOM
...
updrepos() {
	cp ${PREFIX}/share/mhmdtech/etc/apk/repositories ${PREFIX}/share/mhmdtech/etc/apk/repositories.bak
	cat > ${PREFIX}/share/mhmdtech/etc/apk/repositories <<- EOM
...
addresolvconf ()
{
	printf "nameserver 8.8.8.8\nnameserver 8.8.4.4" > ${PREFIX}/share/mhmdtech/etc/resolv.conf
}
